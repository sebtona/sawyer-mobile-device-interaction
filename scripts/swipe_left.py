...
def main():
    ...
    waypoints.add_waypoint({'right_j6': 3.0272236328125, 'right_j5': 0.950677734375, 'right_j4': 1.4704931640625, 'right_j3': 1.3524951171875, 'right_j2': -0.9078623046875, 'right_j1': 0.0725263671875, 'right_j0': -0.5309833984375})
    waypoints.add_waypoint({'right_j6': 3.0272236328125, 'right_j5': 1.0411318359375, 'right_j4': 1.5958193359375, 'right_j3': 1.32327734375, 'right_j2': -1.0367529296875, 'right_j1': 0.19278125, 'right_j0': -0.5059384765625})
    waypoints.add_waypoint({'right_j6': 3.0309296875, 'right_j5': 1.1937646484375, 'right_j4': 1.919677734375, 'right_j3': 1.463240234375, 'right_j2': -1.22602734375, 'right_j1': 0.39150390625, 'right_j0': -0.3607724609375})
    waypoints.add_waypoint({'right_j6': 3.2007080078125, 'right_j5': 1.2138154296875, 'right_j4': 1.7166533203125, 'right_j3': 1.379529296875, 'right_j2': -1.2819365234375, 'right_j1': 0.345080078125, 'right_j0': -0.40238671875})
    waypoints.go()
